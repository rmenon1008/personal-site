        ...
        <div id="post-<?php the_ID(); ?>">
            ...
            <div class="title-buttons" style="display:inline; width:100%">
                ...
                <ul class="wp-block-social-links has-medium-icon-size is-style-pill-shape" style="float: right; margin-top: 20px;">
                    <li class="wp-social-link wp-social-link wp-block-social-link" id="email-copy"><a class="wp-block-social-link-anchor"><svg id="email-success" width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
                                <path d="M20,4H4C2.895,4,2,4.895,2,6v12c0,1.105,0.895,2,2,2h16c1.105,0,2-0.895,2-2V6C22,4.895,21.105,4,20,4z M20,8.236l-8,4.882 L4,8.236V6h16V8.236z"></path>
                            </svg></a></li>
                    <li class="wp-social-link wp-social-link wp-block-social-link"><a href="https://www.linkedin.com/in/rohan-menon-46518415a/" target="_blank" aria-label="LinkedIn" class="wp-block-social-link-anchor"> <svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
                                <path d="M19.7,3H4.3C3.582,3,3,3.582,3,4.3v15.4C3,20.418,3.582,21,4.3,21h15.4c0.718,0,1.3-0.582,1.3-1.3V4.3 C21,3.582,20.418,3,19.7,3z M8.339,18.338H5.667v-8.59h2.672V18.338z M7.004,8.574c-0.857,0-1.549-0.694-1.549-1.548 c0-0.855,0.691-1.548,1.549-1.548c0.854,0,1.547,0.694,1.547,1.548C8.551,7.881,7.858,8.574,7.004,8.574z M18.339,18.338h-2.669 v-4.177c0-0.996-0.017-2.278-1.387-2.278c-1.389,0-1.601,1.086-1.601,2.206v4.249h-2.667v-8.59h2.559v1.174h0.037 c0.356-0.675,1.227-1.387,2.526-1.387c2.703,0,3.203,1.779,3.203,4.092V18.338z"></path>
                            </svg></a></li>
                    <li class="wp-social-link wp-social-link wp-block-social-link"><a href="https://hackaday.io/rohanmenon" target="_blank" aria-label="Hackaday" class="wp-block-social-link-anchor"> <svg width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" preserveAspectRatio="xMidYMin slice" focusable="false">
