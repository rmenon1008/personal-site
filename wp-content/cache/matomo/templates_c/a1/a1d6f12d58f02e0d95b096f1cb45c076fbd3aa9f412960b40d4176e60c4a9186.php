...
class __TwigTemplate_3868041355922900ee89c1220c20f49b64f84fd771f89830a3a06ff13bf9aaa6 extends Template
{
    private $source;
    private $macros = [];
    ...
    <th class=\"orderBy ";
        // line 5
        if ((0 === twig_compare("absolute", twig_get_attribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 5, $this->source); })()), "order_by", [], "any", false, false, false, 5)))) {
            echo "active";
        }
        echo "\"
    ...
    <th class=\"last orderBy ";
        // line 9
        if ((0 === twig_compare("relative", twig_get_attribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 9, $this->source); })()), "order_by", [], "any", false, false, false, 9)))) {
            echo "active";
        }
        echo "\"
...
</tr>", "@Insights/table_header.twig", "/home/rohan/Desktop/Personal_Site_WordPress/wp-content/plugins/matomo/app/plugins/Insights/templates/table_header.twig");
    }
}
